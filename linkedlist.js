...
function main (){
    ...
    let initdata = ["Apollo", "Boomer", "Helo", "Husker", "Starbuck"];

    initdata.forEach(el => SLL.insertLast(el));
    ...
    console.log("\nCurrent Items in list after modifications \n=====================");
    SLL.display();
    console.log("=====================\n");

    console.log("Size of list: " + SLL.size());
    console.log("Is list empty: " +SLL.isEmpty());
    console.log("Finding item before Boomer: " +SLL.findPrevious("Boomer").value);
    console.log("The last entry is: " +SLL.findLast().value);

    SLL.reverse();
    
    console.log("\nCurrent Items in list after Reverse function \n=====================");   
    SLL.display();
    console.log("=====================\n");
    
    console.log(SLL.middle().value);


    SLL.sort();

    console.log("\nCurrent Items in list after Sorting function \n=====================");   
    SLL.display();
    console.log("=====================\n");
}
